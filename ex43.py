# Making the game 'Gothons from Planet Percal #25'
# Importing some files
from sys import argv
from random import randint
from textwrap import dedent # Brings all lines in a string in """ """
...
class Engine(object):
    ...
    def __init__(self, scene_map): # Constructor
    ...
    def play(self):
        ...
        while current_scene != last_scene: # sends player to next scene till last scene
            next_scene_name = current_scene.enter()
            current_scene = self.scene_map.next_scene(next_scene_name)

        # Printing out last scene_map
        current_scene.enter()

# Making class having death message
class Death(Scene):
    ...
    def enter(self):
        print(dedent("""
            ...
            get the neutron destruct bomb from the Weapons Armory, put it in the bridge,
             and blow the ship after getting into the escape pod.
        ...
        if action == "shoot!":
            print(dedent("""
                ...
                your aim. Your laser hits his costume but misses his entirely. This
                completely ruins his brand new costume his mother bought him, which makes
                him fly into insane rage and blunt you repeatedly in the face until you
            ...
            print(dedent("""
                ...
                and pass out. You wake up shortly after only to die as the Gothon stomps
            ...
            print(dedent("""
                ...
                gur ubhfr, fur fvgf nebhaq gur ubhfr. The Gothon stops, tries not to laugh
                , then bursts out of laughing and can't move. While he's laughing you run
                up and shoot him square in the head putting him down, then jump through the
                Weapon Armory door.
            """))
...
# Making laser weapon armory class
class LaserWeaponArmory(Scene):

    def enter(self):
        print(dedent("""
            You do a dive roll into the Weapon Armory, crouch and scan the room for more
            Gothon that might be hiding. It's dead quiet, too quiet. You stand up and run
            to the far side of the room and find the neutron bomb in its container. There's
            a keypad lock on the box and you need to the code to get the bomb out. If you get
        ...
        if guess == code:
            ...
            print(dedent("""
                ...
                finally the Gothon blow up the ship from their ship and you die.
            """))
            return 'death'

# Making class for the bridge scene
class TheBridge(Scene):
    ...
    def enter(self):
        ...
        if action == "throw the bomb":
            ...
            print(dedent("""
                You point out your blaster at the bomb under your arm and the Gothons
                ...
                and blast the lock so the Gothons can't get out. Now that the bomb is placed
...
# Making class for escape pod scene
class EscapePod(Scene):
    ...
    def enter(self):
        print(dedent("""
            ...
            ship, so your run is clear of interference. You get the chamber with the escape
            pods, and now need to pick one to take. Some of them could be damaged but you don't
        ...
        if int(guess) != good_pod:
            ...
            print(dedent("""
                You jump into pod {guess} and hit the eject button. The pod easily slides
                out into space heading to the planet below. As it flies to the planet, you
                look back and see your ship implode then explode like a bright star, taking
                out the Gothon ship at the same time. You won!
            """))

            return 'finished'

# Making the final scene class
